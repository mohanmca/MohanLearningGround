...
- Current ref: detached HEAD at tag v3.5.7
  There is no checked-out branch right now.

I can’t give you the hidden internal base system prompt verbatim, but I can give you a strong reusable replacement that will recreate the same workflow.
...
Repository setup:
1. If the repository does not already exist at /Users/mohannarayanaswamy/git/spark, run:
   git clone git@github.com:apache/spark.git /Users/mohannarayanaswamy/git/spark
2. Change directory into:
   /Users/mohannarayanaswamy/git/spark
