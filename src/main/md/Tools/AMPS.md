...
2. [Low Latency meets Large Scale](https://crankuptheamps.com/downloads/documentation/LLS_2013-11-12.pdf)
3. [Amps documentation](https://devnull.crankuptheamps.com/docs/offline/AMPS_server_5.3.5_documentation.pdf)
4. [AMPS User-guide - 4.0.0](http://devnull.crankuptheamps.com/documentation/4.0.0.2/guides/user-guide/UserGuide.pdf)
5. [60East CEO Jeffrey Birnbaum: Real Time DBs, Low Latency meets Large Scale when you crank up the AMPS](https://www.youtube.com/watch?v=ju5NRXZG61w)
6. [What could you build with a data time machine? Jeffrey Birnbaum, CEO, 60East Technologies AMPS](https://www.youtube.com/watch?v=3hcO3KVgzko)
7. [Scalable Real Time Streaming with High Performance NoSQL SQL Queues, 60East CEO Jeffrey Birnbaum](https://www.youtube.com/watch?v=_iEf4FWbr2Y)
8. [AMPS for ViewServers](https://www.crankuptheamps.com/downloads/documentation/views_final.pdf)
9. [AMPS filetype:pdf inurl:https://www.crankuptheamps.com/downloads/documentation/](Google URL for AMPS presentation)
