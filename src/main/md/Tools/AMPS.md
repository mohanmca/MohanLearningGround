...
3. [AMPS User-guide - 4.0.0](http://devnull.crankuptheamps.com/documentation/4.0.0.2/guides/user-guide/UserGuide.pdf)
4. [60East CEO Jeffrey Birnbaum: Real Time DBs, Low Latency meets Large Scale when you crank up the AMPS](https://www.youtube.com/watch?v=ju5NRXZG61w)
5. [What could you build with a data time machine? Jeffrey Birnbaum, CEO, 60East Technologies AMPS](https://www.youtube.com/watch?v=3hcO3KVgzko)
6. [Scalable Real Time Streaming with High Performance NoSQL SQL Queues, 60East CEO Jeffrey Birnbaum](https://www.youtube.com/watch?v=_iEf4FWbr2Y)
7. [AMPS for ViewServers](https://www.crankuptheamps.com/downloads/documentation/views_final.pdf)
8. [AMPS filetype:pdf inurl:https://www.crankuptheamps.com/downloads/documentation/](Google URL for AMPS presentation)
