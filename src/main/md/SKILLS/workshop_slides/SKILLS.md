...
- Keep CSS, JavaScript, diagrams, and other runtime assets inline so the deck works offline without external JavaScript dependencies.
...
- Add a retention check to each step and mark it mastered only after a correct answer.
- Show overall mastery progress and a sidebar timeline with active, mastered, and unseen states.
