...
1. Higher impact learning is often uncomfortable learning
1. How to ask good questions.
1. How to effectively fail
1. Try again and every failure should change your mind
1. Come up with as many different ways of thinking about it as possible

## True learning emerges from

1. Messing things up
2. Challenging basic assumptions
3. Try new unexpected directions
4. Incremental and subtle improvements (not revolutionary, it is evolutionary)

## What is Thinking

1. Effective thinking is skill
2. Practicing by analyzing different situations from different angles
...
1. Think straight
2. Think upside down
3. Think mirror image
4. Inversion thinking
    1. How to spoilt something
    2. How to make it fail
    3. How to destroy

## Notes from Rajan

1. He doesn't trust his memory, and believes that he is so bad at remembering things.
2. He also believes that he likes to solve problem, but lack any prior knowledge in anything, For example, he codes in
   python, but can't guess the library that can parse html, since never handled it
...
1. Engage in discussions and debates to share your diagrams and notes. When they are reviewed by others, they become
   even more useful.

## Awarness and knowing well with exact sample are different level of knowledge.

1. Knowing about Run-length-encoding is one
2. Knowing how multiple product details are stored using bitma-index inside parquet file and encoded using RLE with
   sample data would be different level of knowledge

## Improve problem solving skills

1. Solve problems
1. Afterward, reflect on what went well and what didn't
1. Write down what you should have done differently
1. Solve more problems, keep those notes handy
1. Repeat
...
1. When we solve a problem that has many facts, we might stuck by missing one or two fact, or we might misinterpret one
   or two fact
...
1. It is spectrum
    1. Where are we within the spectrum
    2. How to measure
    3. How we arrived now with the current knowledge
    4. How to move from this stage
3. Start with simple and basics
    1. Direct simple case with good depth details
5. Spotlight on specific
    1. Think microleve... so macrolevel
7. Add as many adjectives as possible
...
## Effective Failure as learning tools

1. Fail effectively
    1. We can always fail quickly
    2. Gain new insight from failure
    3. Never waste a failure without learning a lesson
3. Fail fast
    1. Focus on process
    2. Don't strare blank screen, start something and fail
5. Fail again
    1. "If at first, you don't succeed, then skydiving definitely isn't for you"
    2. Fail 10 times, so 9 more to go
    3. Every failure gives learning
    4. After 10 failure, our basic assumptions are wrong
7. Fail Intentionally
    8. Stress test and make it fail
    9. Degerate the puzzle and make it fail
    10. Use it to the extreem and observe failure
...
2. Be socrates - Ask what is the problem here?
    3. Never ask "Non productive question"
    3.
        4. Rather asking "How to manage large traffic jam, think how to use it effectively"
3. What if .... question?
...
1. What is different but releated view
2. From post, landline to smarphone, what next?
1. Run down all the path and understand all the failures and its natures
2. Embrace doubt, show empathy not necessary about sympathy
